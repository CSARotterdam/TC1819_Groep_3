...
//            startActivity(new Intent(HomeActivity.this, ReturnItemActivity.class));
//        } else if(id == R.id.statistieken){
//            startActivity(new Intent(HomeActivity.this, statistic.class));
...
//                        LoginActivity.logged_in = false;
//                        Toast.makeText(HomeActivity.this, getString(R.string.uitgelogd), Toast.LENGTH_SHORT).show();
